...
export function SignInForm({ nextUrl = '/dashboard', showResetSuccess = false }: Props) {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
      ...
      <form onSubmit={handleEmailSignIn} className="space-y-4">
        ...
        <div>
          <label htmlFor="signin-email" className="mb-1.5 block text-sm font-medium text-gray-700">Email</label>
          <input
            id="signin-email"
            type="email"
            value={email}
